...
Adapted from https://github.com/droid-dataset/droid_policy_learning/tree/master
"""
...
class DiffusionPolicyUNet(PolicyAlgo):
    ...
    def train_on_batch(self, batch, epoch, validate=False):
        ...
        with TorchUtils.maybe_no_grad(no_grad=validate):
            ...
            noise_pred = self.nets['policy'].model['noise_pred_net'](
    ...
    def get_action(self, obs_dict, goal_mode=None, eval_mode=False, goal_dict=None):
        """
