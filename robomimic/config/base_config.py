...
class BaseConfig(Config):
    ...
    def experiment_config(self):
        ...
        self.experiment.epoch_every_n_steps = (
            100  # number of gradient steps in train epoch (None for full dataset pass)
        )
        self.experiment.validation_epoch_every_n_steps = (
            10  # number of gradient steps in valid epoch (None for full dataset pass)
        )
        ...
        self.experiment.additional_envs = (
    ...
    def observation_config(self):
        ...
        self.observation.encoder.rgb.core_kwargs.backbone_kwargs.input_coord_conv = (
            False
        )
        ...
        self.observation.encoder.rgb.core_kwargs.pool_kwargs.num_kp = (
            32  # Default arguments for "SpatialSoftmax"
        )
        self.observation.encoder.rgb.core_kwargs.pool_kwargs.learnable_temperature = (
            False  # Default arguments for "SpatialSoftmax"
        )
        self.observation.encoder.rgb.core_kwargs.pool_kwargs.temperature = (
            1.0  # Default arguments for "SpatialSoftmax"
        )
        self.observation.encoder.rgb.core_kwargs.pool_kwargs.noise_std = (
            0.0  # Default arguments for "SpatialSoftmax"
        )
        self.observation.encoder.rgb.core_kwargs.pool_kwargs.output_variance = (
            False  # Default arguments for "SpatialSoftmax"
        )
        ...
        self.observation.encoder.rgb.obs_randomizer_kwargs.pos_enc = (
            False  # Default arguments for "CropRandomizer"
        )
