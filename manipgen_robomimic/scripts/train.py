...
from manipgen_robomimic.algo import algo_factory, RolloutPolicy
from manipgen_robomimic.utils.log_utils import PrintLogger, DataLogger, flush_warnings
...
def train(config, device):
    ...
    print("*" * 50)
    print("Warnings generated by manipgen_robomimic have been duplicated here (from above) for convenience. Please check them carefully.")
    flush_warnings()
    print("*" * 50)
    print("")
