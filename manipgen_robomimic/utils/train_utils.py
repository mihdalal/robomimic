...
import manipgen_robomimic.utils.log_utils as LogUtils
import manipgen_robomimic.utils.file_utils as FileUtils

from manipgen_robomimic.utils.dataset import SequenceDataset
from manipgen_robomimic.envs.env_base import EnvBase
from manipgen_robomimic.envs.wrappers import EnvWrapper
from manipgen_robomimic.algo import RolloutPolicy
...
def get_exp_dir(config, auto_remove_exp_dir=False):
    ...
    if not os.path.isabs(base_output_dir):
        # relative paths are specified relative to manipgen_robomimic module location
        base_output_dir = os.path.join(manipgen_robomimic.__path__[0], base_output_dir)
