"""
Set of global variables shared across sp_robomimic
"""
...
try:
    from sp_robomimic.macros_private import *
except ImportError:
    ...
    log_warning(
        ...
        "\nTo setup, run: python {}/scripts/setup_macros.py".format(sp_robomimic.__path__[0])
    )
