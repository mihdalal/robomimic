...
import sp_robomimic.utils.log_utils as LogUtils
import sp_robomimic.utils.file_utils as FileUtils

from sp_robomimic.utils.dataset import SequenceDataset, SequenceInMemoryDataset
from sp_robomimic.envs.env_base import EnvBase
from sp_robomimic.envs.wrappers import EnvWrapper
from sp_robomimic.algo import RolloutPolicy
...
def get_exp_dir(config, auto_remove_exp_dir=False):
    ...
    if not os.path.isabs(base_output_dir):
        # relative paths are specified relative to sp_robomimic module location
        base_output_dir = os.path.join(sp_robomimic.__path__[0], base_output_dir)
