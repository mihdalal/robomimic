...
Example usage:
    ...
    # downloads to default path at sp_robomimic/datasets/d4rl
...
from sp_robomimic.utils.log_utils import custom_tqdm
...
if __name__ == "__main__":
    ...
    if base_folder is None:
        base_folder = os.path.join(sp_robomimic.__path__[0], "../datasets")
